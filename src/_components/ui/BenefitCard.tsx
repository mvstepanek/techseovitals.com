...
const BenefitCard: React.FC<BenefitCardProps> = ({
  ...
  return (
    <div className={`group relative bg-white p-8 rounded-2xl border ${colors.border} ${colors.hover} hover:shadow-lg transition-all duration-300 overflow-hidden sm:overflow-visible ${className}`}>
      {/* Icon */}
