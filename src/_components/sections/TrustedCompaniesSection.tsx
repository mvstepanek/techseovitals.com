      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-8 items-center justify-items-center max-w-4xl mx-auto">
            ...
            <div className="group p-4 sm:p-6 md:p-8 rounded-2xl bg-gray-50 hover:bg-white hover:shadow-lg transition-all duration-300 w-full flex items-center justify-center col-span-2 md:col-span-1 lg:col-span-3 max-w-xs mx-auto md:max-w-none">
              <img
