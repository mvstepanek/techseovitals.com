...
const CookieConsentBar: React.FC<CookieConsentBarProps> = ({ t = (key) => key }) => (
  <div id="cookie-consent" className="fixed bottom-3 left-3 right-3 sm:bottom-4 sm:left-4 sm:right-4 md:left-6 md:right-6 lg:bottom-6 lg:left-8 lg:right-8 z-[60] hidden">
