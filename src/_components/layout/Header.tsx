      ...
      <div className="flex items-center justify-between py-4">
        ...
        <nav className="hidden lg:flex lg:items-center lg:space-x-8" aria-label="Main navigation">
          <div className="relative group">
            <a
              className={`relative font-medium transition-all duration-200 py-2 ${
                currentPath === '/technical-seo-services/'
                  ? 'text-purple-600'
            ...
            >
              Services
              <span className={`absolute bottom-0 left-0 w-full h-0.5 bg-purple-600 transform origin-left transition-transform duration-200 ${
                currentPath === '/technical-seo-services/'
                  ? 'scale-x-100'
          ...
          <div className="relative group">
            <a
              className={`relative font-medium transition-all duration-200 py-2 ${
                currentPath === '/technical-seo-consultant/'
                  ? 'text-purple-600'
                  : 'text-gray-700 hover:text-purple-600'
              }`}
