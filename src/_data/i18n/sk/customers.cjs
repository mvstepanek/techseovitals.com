...
module.exports = {
  ...
  "customers.touchit.metric1.label": "Zníženie LCP",
  "customers.touchit.metric2.value": "70%",
  "customers.touchit.metric2.label": "Pokles bounce rate",
  "customers.touchit.metric3.value": "80%",
  "customers.touchit.metric3.label": "Nárast zobrazení stránok",
