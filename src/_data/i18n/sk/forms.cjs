/**
 * Forms translations - SK
 * Auto-generated from split-i18n.cjs script
 */

module.exports = {
  "form.placeholder.first-name": "Krstné meno",
  "form.placeholder.email": "E-mail",
  "form.privacy.no-spam": "Žiadny spam. Odhlásenie kedykoľvek jedným klikom.",
  "form.privacy.consent": "Prihlásením súhlasím so",
  "form.privacy.and": "a",
