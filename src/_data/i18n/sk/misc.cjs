...
module.exports = {
  ...
  "topbar.new": "Novinka",
  "topbar.vitalsentinel": "Spustil som VitalSentinel - Nástroj na monitorovanie technického SEO a výkonu webu",
  ...
  "footer.technical-seo-checklist": "Technický SEO checklist",
  "footer.website-migration-checklist": "SEO migračný checklist",
  "footer.web-performance-metrics": "5 kľúčových webových metrík pre každého podnikateľa",
