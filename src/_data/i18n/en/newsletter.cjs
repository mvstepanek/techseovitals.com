...
module.exports = {
  ...
  "newsletter.hero.badge": "Biweekly Newsletter",
  "newsletter.hero.title": "Get Technical SEO Insights That <span>Drive Results</span>",
  "newsletter.hero.description": "Learn how top businesses create websites that users love and search engines reward. Get practical strategies for technical SEO and performance optimization delivered to your inbox every two weeks.",
  "newsletter.hero.trust-signals": "Recommended by industry leaders",
  "newsletter.form.title": "Subscribe Now",
  "newsletter.form.subtitle": "Get actionable insights every two weeks",
