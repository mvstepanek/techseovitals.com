...
module.exports = {
  ...
  "brutal-truth.card1.stat-label": "Revenue lost per 100ms delay",
  "brutal-truth.card1.title": "Users Feel Every Delay",
  "brutal-truth.card1.description": "Amazon discovered users perceive even 100ms delays. When frustrated by slow performance, they abandon purchases - costing businesses 1% revenue per 100ms delay.",
  ...
  "brutal-truth.card2.description": "Users give you exactly 3 seconds before deciding your site is not worth their time. Google found 53% of customers leave after those 3 seconds, taking their business elsewhere.",
  ...
  "brutal-truth.card3.title": "First Impressions Matter",
  "brutal-truth.card3.description": "79% of users who faced a poor website experience won't give you a second chance. Search engines and AI platforms rely on the same signals that create good user experiences."
};
