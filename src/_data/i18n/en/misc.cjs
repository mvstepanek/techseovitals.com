...
module.exports = {
  ...
  "brutal.title": "The <span>Harsh Truth</span> About Your Website",
  "brutal.subtitle": "Technical issues destroy user trust. Slow pages, broken navigation, and poor structure frustrate real customers trying to use your site. When users struggle, your business suffers.",
  "brutal.card1.badge": "Amazon Study",
  "brutal.card1.stat": "1%",
  "brutal.card1.subtitle": "Revenue loss per 100ms delay",
  "brutal.card1.title": "Users notice every delay",
  "brutal.card1.description": "Amazon discovered that users notice even 100ms delays. When frustrated by slow performance, they abandon purchases - costing businesses 1% of revenue for every 100ms delay.",
  "brutal.card2.badge": "Google Study",
  "brutal.card2.stat": "53%",
  "brutal.card2.subtitle": "Mobile users abandon slow sites",
  "brutal.card2.title": "Patience has limits",
  "brutal.card2.description": "Users give you exactly 3 seconds before deciding your site isn't worth their time. Google found that 53% of customers leave after those 3 seconds and take their business elsewhere.",
  "brutal.card3.badge": "User Experience",
  "brutal.card3.stat": "79%",
  "brutal.card3.subtitle": "Won't return after bad experience",
  "brutal.card3.title": "First impressions count",
  "brutal.card3.description": "79% of users who faced a poor website experience won't give you a second chance. Search engines and AI platforms rely on the same signals that create good user experiences.",
