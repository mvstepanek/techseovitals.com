/**
 * Testimonials translations - EN
 * Auto-generated from split-i18n.cjs script
 */

module.exports = {
  "testimonials.badge": "Client Success Stories",
  "testimonials.title": "Real Results from <span>Real Clients</span>",
  "testimonials.subtitle": "Discover how technical excellence drives real business results.",
  "testimonials.cta": "More success stories",
  "testimonials.trust": "Trusted by 50+ businesses",
