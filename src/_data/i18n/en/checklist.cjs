/**
 * Checklist translations - EN
 * Auto-generated from split-i18n.cjs script
 */

module.exports = {
  "checklist.hero.badge": "Complete Technical SEO Optimization",
  "checklist.hero.title": "Get Your <span>Technical SEO</span> Checklist",
  "checklist.hero.description": "Comprehensive technical SEO checklist covering crawlability, indexability, and site optimization. 100+ actionable items to fix technical issues, improve search visibility, and create experiences that keep visitors engaged and converting.",
  "checklist.hero.trust-signals": "100+ people already using the checklist",
  "checklist.hero.cta": "Download Checklist",
  "checklist.form.title": "Grab Your Free Checklist",
  "checklist.form.subtitle": "Get the checklist delivered to your inbox",
