...
export const PERFORMANCE_BENEFITS = {
  ...
  title: (
    <>
      The 5 Metrics That <span className="bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">Actually Matter</span>
    </>
  ),
...
export const MIGRATION_BENEFITS = {
  ...
  title: (
    <>
      Minimize Migration <span className="bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">Risks and Losses</span>
    </>
  ),
